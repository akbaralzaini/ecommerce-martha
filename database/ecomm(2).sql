...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 29, 2020 at 03:47 PM
...
(35, 1, 'Ring', 'tesss', 'ring', 100000, 's9.jpg', '2020-08-29', 3),
...
(38, 1, 'Sarung Universal Polos (Tab 7.0)', 'tesss', 'sarung-universal-polos-tab-70', 100000, 's9.jpg', '2020-08-20', 1),
...
CREATE TABLE `sales` (
  ...
  `bank` enum('BRI','BNI','BCA','MANDIRI') NOT NULL,
  `foto` text NOT NULL,
  `status` enum('dikonfirmasi','telah dibayar','belum dibayar','') NOT NULL DEFAULT 'belum dibayar',
...
INSERT INTO `sales` (`id`, `user_id`, `pay_id`, `bank`, `foto`, `status`, `sales_date`) VALUES
(9, 9, 'PAY-1RT494832H294925RLLZ7TZA', 'BRI', '', '', '2018-05-10'),
(10, 9, 'PAY-21700797GV667562HLLZ7ZVY', 'BRI', '', '', '2018-05-10'),
(11, 17, 'PAY7821-17', 'MANDIRI', 'asx.png', 'telah dibayar', '2020-08-16'),
(12, 17, 'PAY5812-1720200816', 'BRI', '', '', '2020-08-16'),
(13, 17, 'PAY7358-1720200816', 'BRI', '', '', '2020-08-16'),
(14, 17, 'PAY3755-1720200816', 'BRI', '', '', '2020-08-16'),
(15, 17, 'PAY1436-1720200829', 'MANDIRI', 'asx.png', 'dikonfirmasi', '2020-08-29'),
(16, 15, 'PAY3440-1520200829', 'BRI', '', 'belum dibayar', '2020-08-29');
